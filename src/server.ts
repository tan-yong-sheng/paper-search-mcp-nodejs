...
interface SearchPapersParams {
  query: string;
  platform?: 'arxiv' | 'webofscience' | 'pubmed' | 'wos' | 'biorxiv' | 'medrxiv' | 'semantic' | 'iacr' | 'all';
  maxResults?: number;
  year?: string;
  author?: string;
  journal?: string;
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        platform: { 
          type: 'string', 
          enum: ['arxiv', 'webofscience', 'pubmed', 'wos', 'biorxiv', 'medrxiv', 'semantic', 'iacr', 'all'],
          description: 'Platform to search (arxiv, webofscience/wos, pubmed, biorxiv, medrxiv, semantic, iacr, or all)'
        },
        maxResults: { 
          type: 'number', 
          minimum: 1, 
